...
if __name__ == '__main__':
    ...
    input_raw_files = fs_utils.filter_files_in_folder(INPUT_FOLDER, ['raw.pdf'])
    ...
    for raw_file in raw_files:
        ...
        pdf_cleaner.clean_pdf(raw_file, cleand_file)
    ...
    for cleand_file in cleand_files:
        ...
        pdf_text_extractor.extract_text_from_pdf(cleand_file)
